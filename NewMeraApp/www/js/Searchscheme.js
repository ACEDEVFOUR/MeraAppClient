...
function querySex(tx) {
    var LangId = utils.localStorage().get('LangID');
    var queryText = "SELECT ID, Name FROM Sex  WHERE LangID = '" + LangId + "'";
...
function queryReligion(tx) {
    var LangId = utils.localStorage().get('LangID');
    var queryText = "SELECT ID, Name FROM Religion  WHERE LangID = '" + LangId + "'";
...
function queryCategory(tx) {
    var LangId = utils.localStorage().get('LangID');
    var queryText = "SELECT ID, Name FROM Category  WHERE LangID = '" + LangId + "'";
...
function queryOccupation(tx) {
    var LangId = utils.localStorage().get('LangID');
    var queryText = "SELECT ID, Name FROM Occupation  WHERE LangID = '" + LangId + "' ORDER BY NAME";
...
function queryQualification(tx) {
    var LangId = utils.localStorage().get('LangID');
    var queryText = "SELECT ID, Name FROM Qualification  WHERE LangID = '" + LangId + "' ORDER BY NAME";
...
function queryMaritalStatus(tx) {
    var LangId = utils.localStorage().get('LangID');
    var queryText = "SELECT ID, Name FROM MaritalStatus  WHERE LangID = '" + LangId + "' ORDER BY NAME";
...
function queryDomain(tx) {
    var LangId = utils.localStorage().get('LangID');
    var queryText = "SELECT ID, Name FROM Domain  WHERE LangID = '" + LangId + "'";
...
function queryDepartment(tx) {
    var LangId = utils.localStorage().get('LangID');
    var queryText = "SELECT ID, Name FROM Department  WHERE LangID = '" + LangId + "'";
...
function queryEmpStatus(tx) {
    var LangId = utils.localStorage().get('LangID');
    var queryText = "SELECT ID, Name FROM EmpStatus  WHERE LangID = '" + LangId + "'";
...
function queryVulnerableGroup(tx) {
    var LangId = utils.localStorage().get('LangID');
    var queryText = "SELECT ID, Name FROM VulnerableGroup  WHERE LangID = '" + LangId + "'";
...
function queryDisablity(tx) {
    var LangId = utils.localStorage().get('LangID');
    var queryText = "SELECT ID, Name FROM Disablity  WHERE LangID = '" + LangId + "'";
...
function querySickness(tx) {
    var LangId = utils.localStorage().get('LangID');
    var queryText = "SELECT ID, Name FROM Sickness  WHERE LangID = '" + LangId + "'";
