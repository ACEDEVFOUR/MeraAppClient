...
(function () {
    ...
    //var schemeUrl = utils.Urls.SchemeDtlsUrl + schemeId;
    //if (schemeId == 0) {
    ...
    function querySchemeUploadDocumentSuccess(tx, data) {
        ...
        if (len > 0) {
            ...
            {
                $("#schemeDocDownloadFiles").html("<div><div class=\"clearboth\"></div><div class=\"upper-case\">दस्तावेज उपलब्ध नहीं है।</div></div>");
            }
        }
        ...
        if (mediaCnt == 0) {
            if (LangId == 1) {
                ...
                if (LangId==2)
                {
                    $("#divSchemeMedia").html("<div><div class=\"clearboth\"></div><div class=\"upper-case\">पोस्टर / वीडियो उपलब्ध नहीं है।</div></div>");
                }
        }
    }
