    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (i, dat) {
                ...
                var stmt = "INSERT INTO SubBeneficiary (Id, Beneficiary, FirstName, LastName, FathersName, HusbandsName, DOB, IDProof, IDDetails, State, District, Sex, Age, Religion, Socio, Occupation, MaritalStatus, Category, Department, EmploymentStatus, VulGroup, AnnualIncome, Disabilty, SoochnaPreneur, Photo, Relationship, Sickness, PercentageDisablity, Address, EMail, Phone, IsUpdated, Qualification, DateOfRegistration) VALUES (" + data[i].Id + "," + data[i].BeneficiaryId + ",'" + data[i].FirstName + "','" + data[i].LastName + "','" + data[i].FathersName + "','" + data[i].HusbandsName + "','" + data[i].DOB + "'," + data[i].IDProof + ",'" + data[i].IDDetails + "'," + data[i].State + "," + data[i].District + "," + data[i].Sex + "," + data[i].Age + "," + data[i].Religion + "," + data[i].Socio + "," + data[i].Occupation + "," + data[i].MaritalStatus + "," + data[i].Category + "," + data[i].Department + "," + data[i].EmploymentStatus + "," + data[i].VulGroup + "," + data[i].AnnualIncome + "," + data[i].Disabilty + ",'" + data[i].SoochnaPreneur + "','" + data[i].Photo + "'," + data[i].Relationship + "," + data[i].Sickness + "," + data[i].PercentageDisablity + ",'" + data[i].Address + "','" + data[i].EMail + "','" + data[i].Phone + "','false'," + 0 + ",'" + dateOfRegistration + "'," + data[i].EngDistrictId + ")";
                tx.executeSql(stmt);
            });
        },
        error: function (error) {
...
function PopulateBeneficiary(tx) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (i, dat) {
                var dateOfRegistration = (data[i].DateOfRegistration != null && data[i].DateOfRegistration.length > 0) ? data[i].DateOfRegistration.slice(0, 10).replace(/-/g, '/') : null;
                var stmt = "INSERT INTO Beneficiary (Id, Beneficiary, FirstName, LastName, FathersName, HusbandsName, DOB, IDProof, IDDetails, State, District, Sex, Age, Religion, Socio, Occupation, MaritalStatus, Category, Department, EmploymentStatus, VulGroup, AnnualIncome, Disabilty, SoochnaPreneur, Photo, Relationship, Sickness, PercentageDisablity, Address, EMail, Phone, IsUpdated, Qualification, DateOfRegistration,EngDistrictId) VALUES (" + data[i].Id + "," + data[i].BeneficiaryId + ",'" + data[i].FirstName + "','" + data[i].LastName + "','" + data[i].FathersName + "','" + data[i].HusbandsName + "','" + data[i].DOB + "'," + data[i].IDProof + ",'" + data[i].IDDetails + "'," + data[i].State + "," + data[i].District + "," + data[i].Sex + "," + data[i].Age + "," + data[i].Religion + "," + data[i].Socio + "," + data[i].Occupation + "," + data[i].MaritalStatus + "," + data[i].Category + "," + data[i].Department + "," + data[i].EmploymentStatus + "," + data[i].VulGroup + "," + data[i].AnnualIncome + "," + data[i].Disabilty + ",'" + data[i].SoochnaPreneur + "','" + data[i].Photo + "'," + data[i].Relationship + "," + data[i].Sickness + "," + data[i].PercentageDisablity + ",'" + data[i].Address + "','" + data[i].EMail + "','" + data[i].Phone + "','false'," + 0 + ",'" + dateOfRegistration + "'," + data[i].EngDistrictId + ")";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data.Occupations, function (i, dat) {
                var Occupations = "INSERT INTO Occupation (ID, Name, LangID) VALUES ('" + data.Occupations[i].ID + "','" + data.Occupations[i].Name + "','" + data.Occupations[i].LangID + "')";
                //console.log(i + ' ->' + stmt);
            ...
            tx.executeSql('CREATE TABLE IF NOT EXISTS Department (ID, Name, LangID)');

            $.each(data.Departments, function (i, dat) {
                var Departments = "INSERT INTO Department (ID, Name, LangID) VALUES ('" + data.Departments[i].ID + "','" + data.Departments[i].Name + "','" + data.Departments[i].LangID + "')";
                //console.log(i + ' ->' + stmt);
            ...
            tx.executeSql('CREATE TABLE IF NOT EXISTS Domain (ID, Name, LangID)');

            $.each(data.Domains, function (i, dat) {
                var Domains = "INSERT INTO Domain (ID, Name, LangID ) VALUES ('" + data.Domains[i].ID + "','" + data.Domains[i].Name + "','" + data.Domains[i].LangID + "')";
                //console.log(i + ' ->' + stmt);
    ...
    $.ajax({
        ...
        success: function (data) {
                ...
                $.each(data, function (i, dat) {
                    ...
                    stmt += data[i].MaxAge + ",'" + data[i].Sex + "','" + data[i].MaritalStatusID + "','" + data[i].IncomeId + "','" + data[i].AnnualFamilyIncome + "','";
...
function PopulateEngHinDistrict(tx) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            tx.executeSql('CREATE TABLE IF NOT EXISTS EngHinDistrict (ID, EngStateId, HinStateId, LangID)');
            $.each(data, function (i, dat) {
                var stmt = "INSERT INTO EngHinDistrict (ID, EngStateId, HinStateId, LangID) VALUES (" + data[i].ID + "," + data[i].EngStateId + "," + data[i].HinStateId + "," + data[i].LangID + ")";
                tx.executeSql(stmt);
            });
        },
        error: function (error) {
...
function SyncData() {
    ...
    db.transaction(PopulateScheme, errorScheme);
