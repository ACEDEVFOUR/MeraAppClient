...
function queryBeneficiaries(tx) {
    var queryText = "select Id, FirstName, LastName, IDDetails from Beneficiary where SoochnaPreneur='" + user.userName + "' ORDER BY FirstName";
...
function queryBeneficiariesSuccess(tx, data) {
    ...
    if (len > 0) {
        ...
        for (var i = 0; i < data.rows.length; i++) {
            ...
            listItems += "<option value='" + data.rows[i].Id + "'>" + data.rows[i].Id  + '  ' + fullName + "</option>";
...
function querySubBeneficiaries(tx) {
    var queryText = "select Id, FirstName, LastName, IDDetails from SubBeneficiary where SoochnaPreneur='" + user.userName + "' ORDER BY FirstName";
...
function querySubBeneficiariesSuccess(tx, data) {
    ...
    if (len > 0) {
        ...
        for (var i = 0; i < data.rows.length; i++) {
            ...
            opt.innerHTML = data.rows[i].Id +'  ' + fullName;
