...
function queryLoadBeneficiary(tx) {
    ...
    queryText += " ben.EmploymentStatus, ben.VulGroup, ben.AnnualIncome, ben.Disabilty, ben.Photo, ben.Relationship, ben.Sickness, ben.PercentageDisablity, ben.Beneficiary, ben.Address, ben.EMail, ben.Phone, ben.SoochnaPreneur, ben.Qualification,  ben.Block, ben.Panchayat,ben.Village  ";
     // queryText += ", ed.ID as hDistrict ";
...
function searchSubBeneficiary(tx) {
    ...
    var queryText = "SELECT  ben.Id, ben.FirstName, ben.LastName,  ben.FathersName, ben.HusbandsName, ben.DOB, ben.IDProof, ben.IDDetails ";
    queryText += ", ben.State, ben.District, ben.Sex, ben.Age, ben.Religion,ben.Socio, ben.Occupation, ben.MaritalStatus, ben.Category, ben.Department, ";
    queryText += " ben.EmploymentStatus, ben.VulGroup, ben.AnnualIncome, ben.Disabilty, ben.Photo, ben.Relationship, ben.Sickness,  ben.Beneficiary, ben.Address, ben.EMail, ben.Phone, ben.DateOfRegistration ";
    //queryText += ", ed.ID as hDistrict ";
